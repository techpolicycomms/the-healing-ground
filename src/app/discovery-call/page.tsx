...
export const metadata: Metadata = {
  ...
  description:
    "Book a calm discovery call with Celia de Mestral to explore holistic, mind-body practice for stress, burnout, and nervous system support."
};
            ...
            <div>
              ...
              <div className="mt-7 space-y-5 text-lg leading-8 text-ink/72">
                <p>
                  ...
                  and whether this holistic, mind-body practice feels like the right next
                  step.
                </p>
                <p>
